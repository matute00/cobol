      ...
      ******************************************************************
       ...
       77  WS-AUX-LISTA                PIC X(50) VALUE ' '.

       01  WS-FECHA-MIN                VALUE HIGH-VALUE.
           03 WS-FE-MIN-AAAA           PIC 9(04).
           03 FILLER                   PIC X(01).
           03 WS-FE-MIN-MM             PIC 9(02).
           03 FILLER                   PIC X(01).
           03 WS-FE-MIN-DD             PIC 9(02).

       01  WS-FECHA-MAX                VALUE LOW-VALUE.
           05 WS-FE-MAX-AAAA           PIC X(04).
           05 FILLER                   PIC X(01).
           05 WS-FE-MAX-MM             PIC X(02).
           05 FILLER                   PIC X(01).
           05 WS-FE-MAX-DD             PIC X(02).
       ...
       01  WS-RECAU-ANT.
           ...
           03 WS-CONCEPTO              PIC X(04).
           03 WS-IMPORTE               PIC 9(09)V99.

       01  WS-TITULOS-1.
           05  FILLER                  PIC X(12)  VALUE 'CAJERO'.
           05  FILLER                  PIC X(18)  VALUE 'FECHA'.
           05  FILLER                  PIC X(13)  VALUE 'IMPORTE'.
           05  FILLER                  PIC X(07)  VALUE 'CASOS'.

       01  WS-DETALLE.
           05 WS-COD-DE                PIC 999.
           05 FILLER                   PIC X(07) VALUE ' '.
           05 WS-FECHA-DE.
              07 WS-FECHA-DE-A         PIC 9(04).
              07 FILLER                PIC X(01).
              07 WS-FECHA-DE-M         PIC 9(02).
              07 FILLER                PIC X(01).
              07 WS-FECHA-DE-D         PIC 9(02).
           05 FILLER                   PIC X(02) VALUE ' '.
           05 WS-IMP-DE                PIC Z.ZZZ.ZZZ.ZZ9,99.
           05 FILLER                   PIC X(05) VALUE ' '.
           05 WS-CASOS-DE              PIC ZZ9.
      ...
      *----------------------------------------------------------------*
       ...
       1300-PRIMERA-LECTURA.
           ...
           IF NOT 88-RECAU-FIN
              ...
              PERFORM 1400-IMPRIMO-TITULOS

              MOVE RECAUDACION-REG TO WS-RECAU-ANT
           END-IF.

       1400-IMPRIMO-TITULOS.

           WRITE REG-RESUMEN-FD FROM WS-AUX-LISTA.
           EVALUATE FS-RESUMEN
               WHEN '00'
                    CONTINUE
               WHEN OTHER
      ...
      *----------------------------------------------------------------*
       ...
       2200-ESCRITURA.
           ...
           WRITE REG-RESUMEN-FD  FROM WS-DETALLE
       ...
       2500-CORTE-CONTROL-CAJERO.
           ...
           MOVE SPACE           TO WS-FECHA-DE
           MOVE WS-IMPOR-CAJE   TO WS-IMP-DE
           MOVE WS-CANT-CASOS-C TO WS-CASOS-DE
       ...
       2600-CORTE-CONTROL-FECHA.
           ...
           MOVE WS-COD-CAJA     TO WS-COD-DE
           MOVE WS-FECHA        TO WS-FECHA-DE

           MOVE WS-IMPOR-FECHA  TO WS-IMP-DE
           MOVE WS-CANT-CASOS-F TO WS-CASOS-DE
       ...
       2700-MOVIMIENTOS.
           ...
           ADD WS-IMPORTE TO WS-IMPOR-FECHA

           ADD WS-IMPORTE TO WS-IMPOR-CAJE

           ADD WS-IMPORTE TO WS-IMPOR-TOT

           ADD 1 TO WS-CANT-CASOS-F

           ADD 1 TO WS-CANT-CASOS-C

           ADD 1 TO WS-CANT-CASOS-T.
